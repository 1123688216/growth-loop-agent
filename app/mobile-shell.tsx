...
function MobilePlanV3({ dashboard, tasks, doneCount, onToggleTask, onSplitGoal, onToggleFocus, isFocusRunning }: { dashboard: DemoSeed; tasks: Task[]; doneCount: number; onToggleTask: (id: string) => void; onSplitGoal: (goal: Goal) => void; onToggleFocus: () => void; isFocusRunning: boolean }) {
